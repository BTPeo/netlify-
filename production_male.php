...
<main>
    ...
    <h1 class="product-male product-heading">_ĐỒNG HỒ NAM_</h1>
                ...
                <div class=" col l-12">
                    <div class="row">
                        ...
                        $sql = "SELECT p.*, b.* 
                                ...
                                WHERE p.gioitinh = '0' AND b.tenthuonghieu = 'casio'";
                ...
                <div class="male-citizen col l-12">
                    <div class="row">
                        ...
                        $sql = "SELECT p.*, b.* 
                                FROM production p
                                JOIN brand b ON p.thuonghieu = b.mathuonghieu
                                WHERE p.gioitinh = '0' AND b.tenthuonghieu = 'citizen'";
                        $result = mysqli_query($conn, $sql);
                ...
                <div class="male-doxa col l-12">
                    <div class="row">
                        ...
                        $sql = "SELECT p.*, b.* 
                                FROM production p
                                JOIN brand b ON p.thuonghieu = b.mathuonghieu
                                WHERE p.gioitinh = '0' AND b.tenthuonghieu = 'doxa'";
                        $result = mysqli_query($conn, $sql);
                ...
                <div class="male-tissot col l-12">
                    ...
                    <?php
                        ...
                        $sql = "SELECT p.*, b.* 
                                FROM production p
                                JOIN brand b ON p.thuonghieu = b.mathuonghieu
                                WHERE p.gioitinh = '0' AND b.tenthuonghieu = 'tissot'";
                        $result = mysqli_query($conn, $sql);
